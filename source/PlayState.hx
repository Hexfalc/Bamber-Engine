...
class PlayState extends MusicBeatState
{
  ...
  //character selection
	...
	override public function create()
	{
		...
		case 1:
		boyfriend = new Boyfriend(0, 0, 'bambiboyfriend');
		case 2:
		boyfriend = new Boyfriend(0, 0, 'tristan');
		default:
		boyfriend = new Boyfriend(0, 0, 'bf');
		}
		...
		timeBar.createFilledBar(0x808080, 0x008000);
		...
		scoreTxt = new FlxText(0, healthBarBG.y + 36, FlxG.width, "", 25);
